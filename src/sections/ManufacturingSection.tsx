...
const ManufacturingSection = ({ className = '' }: ManufacturingSectionProps) => {
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 lg:px-[8vw]">
        ...
        <div className="max-w-[44vw] lg:max-w-[580px]">
          ...
          >
            <span className="word inline-block">ISHLAB</span>{' '}
            <span className="word inline-block">CHIQARISH</span>
          </h2>
      ...
      <div
        ref={listRef}
        className="hidden lg:block absolute right-[7vw] top-[36vh] w-[22vw]"
      >
        <div className="space-y-4">
          {processes.map((process) => (
            <div key={process} className="flex items-center gap-3 justify-end">
              <span className="font-mono text-sm text-[#F4F6FA] tracking-wide">{process}</span>
